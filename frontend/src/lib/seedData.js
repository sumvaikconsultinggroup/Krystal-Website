...
export const WINDOWS_PRODUCTS = [
    {
        ...
        specs: [
            {label: "Frame Depth", value: "60mm - 70mm"},
            {label: "Glass Options", value: "Single/Double/Triple glazed"},
            {label: "U-Value", value: "As low as 1.4 W/m²K"},
            {label: "Sound Reduction", value: "Up to 42 dB"},
            {label: "Max Size", value: "1200mm x 1500mm per sash"},
        ],
    ...
    },
    {
        ...
        specs: [
            {label: "Frame Depth", value: "60mm - 80mm"},
            {label: "Track Options", value: "2-track, 3-track, 4-track"},
            {label: "Glass Thickness", value: "5mm - 24mm"},
            {label: "Sound Reduction", value: "Up to 38 dB"},
            {label: "Max Panel Size", value: "1500mm x 2400mm"},
        ],
    ...
    },
    {
        ...
        specs: [
            {label: "Frame Depth", value: "70mm - 82mm"},
            {label: "Hardware", value: "Roto/Siegenia/GU"},
            {label: "U-Value", value: "As low as 1.2 W/m²K"},
            {label: "Sound Reduction", value: "Up to 45 dB"},
            {label: "Security", value: "RC2 rated available"},
        ],
        related_products: ["prod-casement-window", "prod-fixed-window"],
        is_featured: true,
        order: 3
    },
    {
        ...
        specs: [
            {label: "Frame Depth", value: "60mm - 70mm"},
            {label: "Max Size", value: "2500mm x 3000mm"},
            {label: "Glass Options", value: "Up to 44mm triple glazed"},
            {label: "U-Value", value: "As low as 1.0 W/m²K"},
            {label: "Sound Reduction", value: "Up to 48 dB"},
        ],
    ...
    },
    {
        ...
        specs: [
            {label: "Frame Depth", value: "60mm"},
            {label: "Opening Angle", value: "Up to 60°"},
            {label: "Glass Options", value: "Frosted/Clear/Tinted"},
            {label: "Max Size", value: "1200mm x 600mm"},
        ],
        related_products: ["prod-casement-window", "prod-fixed-window"],
        order: 5
    },
    {
        ...
        specs: [
            ...
            {label: "Threshold", value: "Standard/Low/Flush"},
...
export const DOORS_PRODUCTS = [
    {
        ...
        specs: [
            {label: "Frame Depth", value: "60mm - 100mm"},
            {label: "Track Options", value: "2/3/4 panel"},
            {label: "Max Panel Weight", value: "Up to 200kg"},
            {label: "Glass Thickness", value: "Up to 28mm"},
            {label: "Threshold Height", value: "20mm/15mm/Flush"},
        ],
    ...
    },
    {
        ...
        specs: [
            {label: "Frame Depth", value: "70mm - 82mm"},
            {label: "Max Size", value: "1200mm x 2400mm per leaf"},
            {label: "Security", value: "PAS 24 available"},
            {label: "Hardware", value: "Hoppe/Yale/GU"},
            {label: "Fire Rating", value: "30 min available"},
        ],
    ...
    },
    {
        ...
        specs: [
            {label: "Frame Depth", value: "70mm - 90mm"},
            {label: "Configurations", value: "2-7 panels"},
            {label: "Max Opening", value: "Up to 6000mm"},
            {label: "Sightline", value: "From 135mm"},
            {label: "Threshold", value: "Low/Rebated/Flush"},
        ],
    ...
    },
    {
        ...
        specs: [
            {label: "Frame Depth", value: "90mm - 120mm"},
            {label: "Max Panel Size", value: "3000mm x 3000mm"},
            {label: "Max Panel Weight", value: "Up to 400kg"},
            {label: "U-Value", value: "As low as 1.1 W/m²K"},
            {label: "Sound Reduction", value: "Up to 47 dB"},
        ],
...
export const ALL_PRODUCTS = WINDOWS_PRODUCTS.concat(DOORS_PRODUCTS);
...
export const PROJECTS = [
    ...
    },
    {
        ...
        solution: "Full facade solution with high-performance fixed glazing, strategically placed casement windows for common areas, and automated sliding doors at entrance points.",
...
// FAQs
export const FAQS = [
    {id: "faq-1", question: "What is uPVC and why is it better than aluminium?", answer: "uPVC (unplasticized Polyvinyl Chloride) is a rigid, durable plastic that doesn't conduct heat or cold like aluminium. This means uPVC windows provide 3x better thermal insulation, reduce condensation, and offer superior acoustic performance. They're also maintenance-free, never need painting, and won't corrode.", category: "general", order: 1, is_featured: true},
    {id: "faq-2", question: "How long do uPVC windows last?", answer: "Quality uPVC windows from reputable manufacturers like Krystal last 25-30 years with proper care. The frames don't rot, rust, or deteriorate from UV exposure. Hardware may need servicing or replacement after 10-15 years depending on usage.", category: "general", order: 2, is_featured: true},
    {id: "faq-3", question: "What is the cost of uPVC windows per square foot?", answer: "uPVC window prices in Delhi NCR typically range from ₹450-850 per square foot depending on the profile system, glass type, and hardware selected. Premium European profiles with triple glazing and German hardware will be at the higher end, while standard double-glazed units are more economical.", category: "general", order: 3, is_featured: true},
    {id: "faq-4", question: "Do you provide installation services?", answer: "Yes, Krystal provides complete turnkey solutions including precise site measurement, custom fabrication, professional installation, and after-sales service. Our trained installation teams ensure perfect fitting, proper sealing, and optimal performance of every window and door.", category: "installation", order: 4},
    {id: "faq-5", question: "What warranty do you offer?", answer: "We provide comprehensive warranty coverage: 10 years on uPVC profiles against discoloration and warping, 5 years on hardware, and 5 years on sealed glass units. Installation workmanship is guaranteed for 2 years. Extended warranty options are available.", category: "general", order: 5, is_featured: true},
    {id: "faq-6", question: "Can uPVC windows be customized in different colors?", answer: "Absolutely! While white is standard, we offer 50+ laminate finishes including wood grains (oak, walnut, mahogany), solid colors (grey, black, cream), and metallic options. Laminate finishes are applied during manufacturing and are highly durable.", category: "windows", order: 6},
    {id: "faq-7", question: "How much noise can uPVC windows reduce?", answer: "Standard double-glazed uPVC windows reduce noise by 30-35 dB. With acoustic laminated glass and proper sealing, noise reduction can reach 42-47 dB—enough to make a busy road sound like a quiet library. We recommend site assessment for specific recommendations.", category: "windows", order: 7, is_featured: true},
    {id: "faq-8", question: "Are uPVC windows safe and secure?", answer: "Yes, uPVC windows with multi-point locking systems exceed standard security requirements. The robust frame construction, reinforced with galvanized steel where needed, resists forced entry. We offer upgraded security hardware and PAS 24 certified options for enhanced protection.", category: "windows", order: 8},
    {id: "faq-9", question: "How do I clean and maintain uPVC windows?", answer: "uPVC is virtually maintenance-free. Simply wipe frames with a damp cloth and mild soap. Avoid abrasive cleaners. Lubricate hinges and locks annually with light machine oil. Clean drainage holes to prevent water buildup. That's it—no painting or special treatments needed.", category: "maintenance", order: 9},
    {id: "faq-10", question: "What areas do you service?", answer: "We serve all of Delhi NCR including Gurugram, Delhi, Noida, Greater Noida, Faridabad, and Ghaziabad. Our manufacturing facility in Gurugram enables quick delivery across the region. Site visits and installations are available throughout our service area.", category: "general", order: 10},
]

// Testimonials
export const TESTIMONIALS = [
    {id: "test-1", name: "Rajesh Sharma", role: "homeowner", location: "DLF Phase 5, Gurugram", content: "Krystal transformed our home. The noise reduction is remarkable—we forgot we live near a busy road. The quality and finish are outstanding. Highly recommend their casement windows.", rating: 5, is_featured: true},
    {id: "test-2", name: "Ar. Priya Malhotra", role: "architect", company: "Studio Priya", location: "Golf Course Road, Gurugram", content: "As an architect, I'm particular about quality and precision. Krystal delivers on both. Their lift & slide doors are exceptional—smooth operation, slim profiles, perfect installation.", rating: 5, is_featured: true},
    {id: "test-3", name: "Vikram Kapoor", role: "builder", company: "Kapoor Constructions", location: "Sohna Road, Gurugram", content: "We've partnered with Krystal for three projects now. Consistent quality, on-time delivery, and excellent after-sales support. Their team understands commercial project requirements.", rating: 5, is_featured: true},
    {id: "test-4", name: "Meera Gupta", role: "homeowner", location: "Sector 57, Gurugram", content: "Our AC bills dropped by almost 40% after installing Krystal's double-glazed windows. The summer heat stays out, and winter warmth stays in. Best investment we've made.", rating: 5, is_featured: true},
    {id: "test-5", name: "Dr. Sanjay Mehta", role: "homeowner", location: "DLF Phase 2, Gurugram", content: "Excellent product and professional service. The tilt & turn windows are perfect for our bedroom—secure ventilation without opening fully. Very happy with our choice.", rating: 5},
]

// Cities/Service Areas
export const CITIES = [
    {id: "city-gurugram", name: "Gurugram", slug: "gurugram", state: "Haryana", description: "Our home base—we know Gurugram's architectural landscape intimately. From DLF phases to Golf Course Road, Sohna Road to New Gurugram, we've transformed thousands of homes with premium uPVC solutions."},
    {id: "city-delhi", name: "Delhi", slug: "delhi", state: "Delhi", description: "Serving all of Delhi from South Delhi's elegant homes to North Delhi's vibrant neighborhoods. Our uPVC windows provide the noise reduction and thermal comfort Delhi homes need."},
    {id: "city-noida", name: "Noida", slug: "noida", state: "Uttar Pradesh", description: "From Noida's high-rise apartments to sector bungalows, we provide tailored uPVC solutions. Our sliding windows and doors are particularly popular for balcony applications."},
    {id: "city-faridabad", name: "Faridabad", slug: "faridabad", state: "Haryana", description: "Quality uPVC windows and doors for Faridabad homes. We understand the local climate and architectural preferences, delivering solutions that perform year-round."},
    {id: "city-ghaziabad", name: "Ghaziabad", slug: "ghaziabad", state: "Uttar Pradesh", description: "Serving Ghaziabad with premium uPVC products. Our acoustic solutions are especially valued given the area's urban density and noise challenges."},
]

// Design Studio Items
export const COLOR_FINISHES = [
    {id: "color-white", name: "Brilliant White", code: "#FFFFFF", category: "solid", image: IMAGES["texture_white"], is_popular: true},
    {id: "color-cream", name: "Cream", code: "#FFFDD0", category: "solid", image: IMAGES["texture_white"]},
    {id: "color-grey", name: "Anthracite Grey", code: "#383E42", category: "solid", image: IMAGES["texture_white"], is_popular: true},
    {id: "color-oak", name: "Golden Oak", code: "#B5651D", category: "wood_texture", image: IMAGES["texture_wood"], is_popular: true},
    {id: "color-walnut", name: "Walnut", code: "#5D4037", category: "wood_texture", image: IMAGES["texture_wood"]},
    {id: "color-mahogany", name: "Mahogany", code: "#4E0000", category: "wood_texture", image: IMAGES["texture_wood"]},
]

export const GLASS_OPTIONS = [
    {id: "glass-clear", name: "Clear Float Glass", description: "Standard transparent glass for maximum light transmission.", benefits: ["Maximum natural light", "Clear views", "Cost effective"], image: IMAGES["glass_1"]},
    {id: "glass-tinted", name: "Tinted Glass", description: "Solar control tinted glass reduces heat and glare.", benefits: ["Reduces solar heat", "Glare reduction", "Privacy enhancement"], image: IMAGES["glass_1"]},
    {id: "glass-lowe", name: "Low-E Glass", description: "Low emissivity coating reflects heat while allowing light.", benefits: ["Superior insulation", "UV protection", "Energy savings"], image: IMAGES["glass_2"]},
    {id: "glass-laminated", name: "Laminated Glass", description: "PVB interlayer provides safety, security, and acoustic benefits.", benefits: ["Safety if broken", "Noise reduction", "UV blocking"], image: IMAGES["glass_2"]},
    {id: "glass-frosted", name: "Frosted/Obscure Glass", description: "Privacy glass that allows light but obscures view.", benefits: ["Privacy", "Soft light", "Decorative"], image: IMAGES["glass_1"]},
]

export const HARDWARE_ITEMS = [
    {id: "hw-handles", name: "Premium Handles", category: "handles", description: "Ergonomic handles from Hoppe, Roto, and Siegenia in various finishes.", image: IMAGES["hardware_1"]},
    {id: "hw-hinges", name: "Adjustable Hinges", category: "hinges", description: "3D adjustable hinges for perfect alignment and smooth operation.", image: IMAGES["hardware_1"]},
    {id: "hw-locks", name: "Multi-point Locks", category: "locks", description: "Security multi-point locking systems engaging at multiple points.", image: IMAGES["hardware_1"]},
    {id: "hw-mesh", name: "Mosquito Mesh", category: "accessories", description: "Integrated fly screens in various mesh types—fiberglass, SS, and pleated.", image: IMAGES["hardware_1"]},
]

export const DOWNLOADS = [
    {id: "dl-brochure", title: "Krystal Product Brochure", description: "Complete catalog of our uPVC windows and doors with specifications.", category: "brochure", file_url: "#", file_size: "4.2 MB"},
    {id: "dl-care", title: "Care & Maintenance Guide", description: "Tips for keeping your uPVC products in perfect condition.", category: "care_guide", file_url: "#", file_size: "1.1 MB"},
    {id: "dl-warranty", title: "Warranty Policy Document", description: "Detailed terms and conditions of our product warranties.", category: "warranty", file_url: "#", file_size: "520 KB"},
    {id: "dl-cert", title: "Quality Certifications", description: "ISO and quality certifications for our manufacturing processes.", category: "certification", file_url: "#", file_size: "2.3 MB"},
]
