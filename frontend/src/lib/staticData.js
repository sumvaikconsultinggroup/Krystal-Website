...
export const COLOR_FINISHES_COMPREHENSIVE = [
    // SOLID COLORS (Most Popular)
    {id: "color-brilliant-white", name: "Brilliant White", code: "#FFFFFF", category: "solid", 
...
export const GLASS_OPTIONS_COMPREHENSIVE = [
    // BASIC GLASS TYPES
    {
...
export const HARDWARE_COMPREHENSIVE = [
    // HANDLES
    {
