...
WINDOWS_PRODUCTS = [
    ...
    Product(
        ...
        gallery=[IMAGES["glass_1"], IMAGES["villa_2"], IMAGES["commercial_1"]],
    ...
    Product(
        ...
        hero_image=IMAGES["interior_2"],
        gallery=[IMAGES["interior_2"], IMAGES["windows_1"]],
    ...
    Product(
        ...
        hero_image=IMAGES["villa_1"],
        gallery=[IMAGES["villa_1"], IMAGES["villa_2"], IMAGES["doors_1"]],
...
DOORS_PRODUCTS = [
    Product(
        ...
        hero_image=IMAGES["doors_1"],
        gallery=[IMAGES["doors_1"], IMAGES["villa_1"], IMAGES["interior_1"]],
    ...
    Product(
        ...
        hero_image=IMAGES["doors_2"],
        gallery=[IMAGES["doors_2"], IMAGES["interior_2"], IMAGES["villa_2"]],
    ...
    Product(
        ...
        hero_image=IMAGES["villa_2"],
        gallery=[IMAGES["villa_2"], IMAGES["villa_1"], IMAGES["doors_1"]],
    ...
    Product(
        ...
        hero_image=IMAGES["glass_2"],
        gallery=[IMAGES["glass_2"], IMAGES["villa_1"], IMAGES["commercial_1"]],
...
PROJECTS = [
    Project(
        ...
        hero_image=IMAGES["villa_1"],
        gallery=[IMAGES["villa_1"], IMAGES["interior_1"], IMAGES["doors_1"]],
    ...
    Project(
        ...
        hero_image=IMAGES["commercial_1"],
        gallery=[IMAGES["commercial_1"], IMAGES["glass_1"], IMAGES["interior_2"]],
    ...
    Project(
        ...
        hero_image=IMAGES["glass_2"],
        gallery=[IMAGES["glass_2"], IMAGES["commercial_1"]],
